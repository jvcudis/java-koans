...
public class AboutCasting {
	...
	public void implicitTypecast() {
		...
		//NOTE: int + int = int and since c variable is type long, use typecasting 
	}
	...
	public void downCastWithInheritance() {
		...
		// Why isn't there an explicit cast?
		// ANSWER: Because Child is the child of parent which is the child of grandparent.
	...
	public void upCastWithInheritance() {
		...
		// Why do we need an explicit cast here?
		// ANSWER: The child variable is a child object and automatically casted as a Grandparent object
		// by virtue of the assignment operator and it should be parsed to a Parent object 
		// since Grandfather is a superclass of Parent
	...
	public void upCastAndPolymorphism() {
		...
		// ANSWER: Did not expect this. I was thinking that it would display the complain function
		// of the Parent object.
		// But I've tried casting the child into a Parent object and the same complain has been
		// implemented so basically, it really shows that the original object (Child) is used.
	...
	public void classCasting() {
		try {
			...
			// ANSWER: It won't compile if you will not cast o into Sleepable.
